...
const mainNav: NavItem[] = [
  ...
  { label: "Image Forge", href: "/image-forge", icon: <Wand2 size={20} /> },
  { label: "Affiliate Links", href: "/monetization/link-vault", icon: <LinkIcon size={20} /> },
  { label: "Library", href: "/monetization/library", icon: <ImageIcon size={20} /> },
